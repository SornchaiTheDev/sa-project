    ...
    <div className="flex flex-col h-screen justify-center items-center">
      <div className="w-[400px]">
        ...
        <div className="flex flex-col gap-2 mt-4">
          ...
          <Input placeholder="ชื่อผู้ใช้" className="bg-zinc-100" />
          <Label className="text-sm">รหัสผ่าน</Label>
          <Input placeholder="รหัสผ่าน" className="bg-zinc-100" />
          <Button className="w-full mt-2">เข้าสู่ระบบ</Button>
        </div>
        <h6 className="text-sm text-zinc-700 mt-2">
          ฉันยังไ่ม่มีบัญชี <Link href="/hr/auth/sign-up" className="text-zinc-900 font-medium">ลงทะเบียน</Link>
        </h6>
      </div>
    </div>
  );
