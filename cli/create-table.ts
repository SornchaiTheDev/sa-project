...
export const createTable = async () => {
  try {
    const createTableQuery = `
      ...
      ALTER TABLE "JOB_ANNOUNCER" ADD FOREIGN KEY ("Company_ID") REFERENCES "APPROVED_COMPANY" ("Company_ID") ON DELETE CASCADE;

      ALTER TABLE "RELATION_TAGGED" ADD FOREIGN KEY ("Company_ID") REFERENCES "APPROVED_COMPANY" ("Company_ID") ON DELETE CASCADE;

      ALTER TABLE "RELATION_TAGGED" ADD FOREIGN KEY ("Tag_Name") REFERENCES "TAG" ("Tag_Name");

      ALTER TABLE "RELATION_VALIDATE" ADD FOREIGN KEY ("JOBA_Username") REFERENCES "JOB_ANNOUNCER" ("JOBA_Username") ON DELETE CASCADE;
